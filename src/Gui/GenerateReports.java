...
public class GenerateReports extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelBackground.setBackground(new java.awt.Color(215, 235, 255));
        jPanelBackground.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabelPH.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        jLabelPH.setForeground(new java.awt.Color(0, 51, 153));
        jLabelPH.setText("PH");
        jPanelBackground.add(jLabelPH, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 70, 110));

        jLabelMotor.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        jLabelMotor.setText("MOTOR");
        jPanelBackground.add(jLabelMotor, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 150, 90));
        ...
        jPanelBackground.add(Logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 100, 100));

        jPanelBackground2.setBackground(new java.awt.Color(215, 235, 255));
        ...
        jLabelSelectYear.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelSelectYear.setForeground(new java.awt.Color(0, 0, 51));
        jLabelSelectYear.setText("Select Year:");
        jPanelBackground2.add(jLabelSelectYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 390, -1, -1));
        ...
        jPanelBackground2.add(jLabelName, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 60, -1));

        jLabelSSSNumber.setBackground(new java.awt.Color(255, 255, 255));
        jLabelSSSNumber.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelSSSNumber.setForeground(new java.awt.Color(0, 0, 51));
        jLabelSSSNumber.setText("SSS Number:");
        jPanelBackground2.add(jLabelSSSNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 110, 20));

        jLabelPhilHealthNumber.setBackground(new java.awt.Color(255, 255, 255));
        jLabelPhilHealthNumber.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelPhilHealthNumber.setForeground(new java.awt.Color(0, 0, 51));
        jLabelPhilHealthNumber.setText("PhilHealth Number:");
        jPanelBackground2.add(jLabelPhilHealthNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 140, -1));

        jLabelTIN.setBackground(new java.awt.Color(255, 255, 255));
        jLabelTIN.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelTIN.setForeground(new java.awt.Color(0, 0, 51));
        jLabelTIN.setText("TIN:");
        jPanelBackground2.add(jLabelTIN, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, -1, -1));

        jLabelPAGIBIGNumber.setBackground(new java.awt.Color(255, 255, 255));
        jLabelPAGIBIGNumber.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelPAGIBIGNumber.setForeground(new java.awt.Color(0, 0, 51));
        jLabelPAGIBIGNumber.setText("PAGIBIG Number:");
        jPanelBackground2.add(jLabelPAGIBIGNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, -1, -1));

        jLabelTotalAllowance.setBackground(new java.awt.Color(255, 255, 255));
        jLabelTotalAllowance.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelTotalAllowance.setForeground(new java.awt.Color(0, 0, 51));
        jLabelTotalAllowance.setText("Total Allowance:");
        jPanelBackground2.add(jLabelTotalAllowance, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, -1, -1));

        jLabelTotalDeductions.setBackground(new java.awt.Color(255, 255, 255));
        jLabelTotalDeductions.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelTotalDeductions.setForeground(new java.awt.Color(0, 0, 51));
        jLabelTotalDeductions.setText("Total Deductions:");
        jPanelBackground2.add(jLabelTotalDeductions, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, -1, -1));

        jLabelSelectMonth.setBackground(new java.awt.Color(255, 255, 255));
        jLabelSelectMonth.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelSelectMonth.setForeground(new java.awt.Color(0, 0, 51));
        jLabelSelectMonth.setText("Select Month:");
        jPanelBackground2.add(jLabelSelectMonth, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 390, 100, -1));
        ...
        jPanelBackground2.add(jTextFieldNetSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 480, 180, 20));
        ...
        jPanelBackground2.add(jLabelGrossSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 460, -1, -1));
        ...
        jPanelBackground2.add(jLabelNetSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 460, -1, -1));

        jPanelSeparator.setBackground(new java.awt.Color(0, 51, 153));
        ...
        jPanelBackground2.add(jButtonCompute, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 550, 130, -1));

        jTextFieldEmployeeNumber.setEditable(false);
        jTextFieldEmployeeNumber.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldEmployeeNumber.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jPanelBackground2.add(jTextFieldEmployeeNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 220, 20));
        ...
        jPanelBackground2.add(jTextFieldName, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 220, 20));

        jTextFieldSSSNumber.setEditable(false);
        jTextFieldSSSNumber.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldSSSNumber.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jPanelBackground2.add(jTextFieldSSSNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 220, 20));

        jTextFieldPhilHealthNumber.setEditable(false);
        jTextFieldPhilHealthNumber.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldPhilHealthNumber.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jPanelBackground2.add(jTextFieldPhilHealthNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 220, 20));

        jTextFieldTIN.setEditable(false);
        jTextFieldTIN.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldTIN.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jPanelBackground2.add(jTextFieldTIN, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 220, 20));

        jTextFieldPAGIBIGNumber.setEditable(false);
        jTextFieldPAGIBIGNumber.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldPAGIBIGNumber.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jPanelBackground2.add(jTextFieldPAGIBIGNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 220, 20));

        jTextFieldTotalAllowance.setEditable(false);
        jTextFieldTotalAllowance.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldTotalAllowance.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jPanelBackground2.add(jTextFieldTotalAllowance, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 180, 20));
        ...
        jPanelBackground2.add(jTextFieldTotalDeductions, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 310, 180, 20));
        ...
        jPanelBackground2.add(jTextFieldGrossSalary, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 480, 180, 20));

        jComboBoxSelectYear.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jComboBoxSelectYear.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Year", "2024 ", "2025" }));
        jPanelBackground2.add(jComboBoxSelectYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 410, 180, 20));

        jComboBoxSelectMonth.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jPanelBackground2.add(jComboBoxSelectMonth, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 410, 180, 20));

        jLabelEmployeeNumber1.setBackground(new java.awt.Color(255, 255, 255));
        jLabelEmployeeNumber1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelEmployeeNumber1.setForeground(new java.awt.Color(0, 0, 51));
        jLabelEmployeeNumber1.setText("Employee Number:");
        jPanelBackground2.add(jLabelEmployeeNumber1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, -1, -1));
        ...
        jPanelBackground2.add(jLabelGMT, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 550, 170, 20));
        ...
        jPanelBackground2.add(jLabelTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 560, 170, 30));
