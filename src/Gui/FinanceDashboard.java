...
public class FinanceDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelHeader.add(jLabelGreet, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 30, -1, -1));
        ...
        jPanelHeader.add(jLabelDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 60, -1, -1));
        ...
        jPanelHeader.add(jLblUname1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 100, 110));

        jLabel3.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        jLabel3.setText("MOTOR");
        jPanelHeader.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 150, 100));

        jLabel5.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 51, 153));
        jLabel5.setText("PH");
        jPanelHeader.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 70, 120));

        jLabelGMT.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jPanelHeader.add(jLabelGMT, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 30, 210, -1));
        ...
        jPanelHeader.add(jLabelTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 40, 210, 32));
        ...
        jPanelHeader.add(jButtonLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 40, 110, 30));

        jPanelMain.add(jPanelHeader, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1340, 90));

        jPanelFinanceGenRep1.setBackground(new java.awt.Color(215, 235, 255));
        jPanelFinanceGenRep1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jTableEmployeesList.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        ...
        jPanelFinanceGenRep1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 1300, 470));

        jLabelGenRep2.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        jLabelGenRep2.setForeground(new java.awt.Color(0, 51, 153));
        jLabelGenRep2.setText("EMPLOYEE DETAILS");
        jPanelFinanceGenRep1.add(jLabelGenRep2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 330, 40));

        jButtonGenRep.setBackground(new java.awt.Color(0, 0, 51));
        jButtonGenRep.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanelFinanceGenRep1.add(jButtonGenRep, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 20, 160, 20));

        jPanelMain.add(jPanelFinanceGenRep1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 1340, 550));
