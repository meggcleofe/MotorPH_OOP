...
public class ForgotPasswordForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelHeader.add(Logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 110, 110));

        jLabelMotor.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        jLabelMotor.setText("MOTOR");
        jPanelHeader.add(jLabelMotor, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 20, 150, 100));

        jLabelPH.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        jLabelPH.setForeground(new java.awt.Color(0, 51, 153));
        jLabelPH.setText("PH");
        jPanelHeader.add(jLabelPH, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 10, 70, 120));

        jPanelForgotPassword.add(jPanelHeader, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 550, 100));

        jButtonFPSubmit.setBackground(new java.awt.Color(153, 204, 255));
        jButtonFPSubmit.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButtonFPSubmit.setForeground(new java.awt.Color(0, 51, 102));
        jButtonFPSubmit.setText("Submit Request");
        jButtonFPSubmit.setToolTipText("");
        jButtonFPSubmit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonFPSubmitActionPerformed(evt);
            }
        });
        jPanelForgotPassword.add(jButtonFPSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(381, 340, -1, 20));

        jButtonFPCancel.setBackground(new java.awt.Color(204, 204, 204));
        jButtonFPCancel.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButtonFPCancel.setForeground(new java.awt.Color(0, 51, 102));
        ...
        jPanelForgotPassword.add(jButtonFPCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, 100, 20));

        jPanelForgotPasswordLabel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jLabelForgotPassword.setFont(new java.awt.Font("Tahoma", 1, 25)); // NOI18N
        jLabelForgotPassword.setForeground(new java.awt.Color(0, 0, 51));
        jLabelForgotPassword.setText("Request Password Reset");
        jPanelForgotPasswordLabel.add(jLabelForgotPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, 320, 40));

        jPanelForgotPassword.add(jPanelForgotPasswordLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 470, 40));

        jPanelFormContents.setBackground(new java.awt.Color(0, 0, 51));
        ...
        jLabelFPEmpName.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
        jLabelFPEmpName.setForeground(new java.awt.Color(255, 255, 255));
        jLabelFPEmpName.setText("Name:");
        jPanelFormContents.add(jLabelFPEmpName, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, -1, 50));

        jTextFieldFPEmpName.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jPanelFormContents.add(jTextFieldFPEmpName, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 260, 30));

        jLabelFPEmpNum.setBackground(new java.awt.Color(255, 255, 255));
        jLabelFPEmpNum.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
        jLabelFPEmpNum.setForeground(new java.awt.Color(255, 255, 255));
        jLabelFPEmpNum.setText("Employee Number:");
        jPanelFormContents.add(jLabelFPEmpNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, -1, 30));

        jTextFieldFPEmpNum.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jPanelFormContents.add(jTextFieldFPEmpNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 100, 260, 30));

        jPanelForgotPassword.add(jPanelFormContents, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 400, 160));

        jLabelGMT.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jPanelForgotPassword.add(jLabelGMT, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 400, 170, 20));
        ...
        jPanelForgotPassword.add(jLabelTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 410, 170, 30));

        getContentPane().add(jPanelForgotPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 620, 450));
