...
public final class HRDashboard extends javax.swing.JFrame { 
    ...
    */
    ...
    private void initComponents() {
        ...
        jPanelHRMain.setBackground(new java.awt.Color(215, 235, 255));
        ...
        jPanelHeader.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 150, 100));
        ...
        jPanelHeader.add(jLabelGreet, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 20, -1, -1));
        ...
        jPanelHeader.add(jLabelDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, -1, -1));
        ...
        jLblUname1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/photos/LogoMotorPH(small).png"))); // NOI18N
        ...
        jLabel5.setText("PH");
        jPanelHeader.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, -10, 70, 120));
        ...
        jPanelHeader.add(jLabelGMT, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 20, 170, -1));
        ...
        jPanelHeader.add(jLabelTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 40, 170, 32));

        jPanelHRMain.add(jPanelHeader, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1340, 90));

        jPanelManageEmployee.setBackground(new java.awt.Color(215, 235, 255));
        ...
        jTableEmployeeRecords.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        ...
        jPanelManageEmployee.add(jButtonDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 170, 110, 30));
        ...
        jPanelManageEmployee.add(jButtonUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 170, 120, 30));

        jLabelTitleEmployeeList.setBackground(new java.awt.Color(255, 255, 255));
        jLabelTitleEmployeeList.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        jLabelTitleEmployeeList.setForeground(new java.awt.Color(0, 51, 153));
        jLabelTitleEmployeeList.setText("EMPLOYEE DETAILS");
        jPanelManageEmployee.add(jLabelTitleEmployeeList, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 280, 32));
        ...
        jPanelManageEmployee.add(jButtonAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 170, 100, 30));

        jTabbedMain.addTab("Manage Employees", jPanelManageEmployee);

        jPanelPendingLeaveRequest.setBackground(new java.awt.Color(215, 235, 255));
        jPanelPendingLeaveRequest.setForeground(new java.awt.Color(215, 235, 255));
        jPanelPendingLeaveRequest.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabelTitleLeaveRequests.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        jLabelTitleLeaveRequests.setForeground(new java.awt.Color(0, 51, 153));
        jLabelTitleLeaveRequests.setText("LEAVE REQUESTS");
        jPanelPendingLeaveRequest.add(jLabelTitleLeaveRequests, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 152, 250, 40));

        jTablePendingLeaveRequest.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        ...
        jPanelPendingLeaveRequest.add(jScrollPaneLeaveRequests, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 1090, 420));

        jButtonApprove.setBackground(new java.awt.Color(0, 0, 51));
        jButtonApprove.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanelPendingLeaveRequest.add(jButtonApprove, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 160, 110, 30));

        jButtonReject.setBackground(new java.awt.Color(0, 0, 51));
        jButtonReject.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanelPendingLeaveRequest.add(jButtonReject, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 160, 110, 30));

        jButtonHistory.setBackground(new java.awt.Color(0, 0, 51));
        ...
        jPanelPendingLeaveRequest.add(jButtonHistory, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 160, 100, 30));

        jTabbedMain.addTab("Leave Requests", jPanelPendingLeaveRequest);

        jPanelProcessedLeaveRequest.setBackground(new java.awt.Color(215, 235, 255));
        ...
        jLabelTitleLeaveRequests1.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        jLabelTitleLeaveRequests1.setForeground(new java.awt.Color(0, 0, 51));
        jLabelTitleLeaveRequests1.setText("LEAVE REQUESTS");
        jPanelProcessedLeaveRequest.add(jLabelTitleLeaveRequests1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 260, 32));

        jTableProcessedLeaveRequest.setFont(new java.awt.Font("Segoe UI Semibold", 0, 12)); // NOI18N
        ...
        jPanelProcessedLeaveRequest.add(jScrollPaneLeaveRequests1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 1090, 420));

        jButtonHistoryApprove.setBackground(new java.awt.Color(0, 0, 51));
        jButtonHistoryApprove.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanelProcessedLeaveRequest.add(jButtonHistoryApprove, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 160, 110, 30));

        jButtonHistoryReject.setBackground(new java.awt.Color(0, 0, 51));
        jButtonHistoryReject.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanelProcessedLeaveRequest.add(jButtonHistoryReject, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 160, 110, 30));

        jButtonPending.setBackground(new java.awt.Color(0, 0, 51));
        jButtonPending.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanelProcessedLeaveRequest.add(jButtonPending, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 160, 100, 30));
        ...
        jPanelSidebar.setBackground(new java.awt.Color(215, 235, 255));
        jPanelSidebar.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jButtonManageEmployees.setBackground(new java.awt.Color(0, 0, 51));
        jButtonManageEmployees.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        jPanelSidebar.add(jButtonManageEmployees, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 170, 40));

        jButtonLeaveRequests.setBackground(new java.awt.Color(0, 0, 51));
        jButtonLeaveRequests.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        jPanelSidebar.add(jButtonLeaveRequests, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 170, 40));
        ...
        jPanelHRMain.add(jButtonLogout, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 580, 130, 30));
